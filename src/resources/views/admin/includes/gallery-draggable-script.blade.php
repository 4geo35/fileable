    ...
    @if (! $hasSearch)
        <script type="application/javascript">
            (function () {
                ...
                document.addEventListener("update-gallery-list", function () {
                    setTimeout(() => makeGalleryDraggable(), 500)
                })
            })()

            function makeGalleryDraggable() {
                let roots = document.querySelectorAll("{{ '[drag-gallery-root' . $postfix . ']' }}")
